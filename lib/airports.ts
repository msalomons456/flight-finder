...
// Coordinates [lng, lat] for airports likely to appear in results
export const AIRPORT_COORDS: Record<string, [number, number]> = {
  // North America
  JFK: [-73.779, 40.640], LGA: [-73.873, 40.776], EWR: [-74.169, 40.690],
  BOS: [-71.005, 42.364], PHL: [-75.241, 39.872], DCA: [-77.038, 38.852],
  IAD: [-77.456, 38.944], BWI: [-76.668, 39.175], ATL: [-84.428, 33.637],
  MIA: [-80.290, 25.796], FLL: [-80.153, 26.072], MCO: [-81.309, 28.429],
  ORD: [-87.905, 41.979], MDW: [-87.752, 41.786], DTW: [-83.353, 42.213],
  MSP: [-93.222, 44.882], LAX: [-118.409, 33.943], SFO: [-122.379, 37.619],
  SJC: [-121.929, 37.363], OAK: [-122.221, 37.721], SEA: [-122.309, 47.449],
  DFW: [-97.038, 32.897], IAH: [-95.279, 29.984], DEN: [-104.674, 39.856],
  LAS: [-115.152, 36.080], PHX: [-112.012, 33.435], SAN: [-117.190, 32.734],
  PDX: [-122.598, 45.589], SLC: [-111.978, 40.788], HNL: [-157.922, 21.318],
  BUR: [-118.359, 34.201], YYZ: [-79.631, 43.677], YVR: [-123.184, 49.194],
  YUL: [-73.741, 45.470], YYC: [-114.021, 51.131],
  // Latin America / Caribbean
  MEX: [-99.072, 19.436], CUN: [-86.877, 21.037], GRU: [-46.473, -23.432],
  GIG: [-43.243, -22.810], BOG: [-74.149, 4.702], MDE: [-75.590, 6.165],
  LIM: [-77.114, -12.022], EZE: [-58.535, -34.822], SCL: [-70.787, -33.393],
  UIO: [-78.488, -0.129], PTY: [-79.383, 8.994], PUJ: [-68.363, 18.567],
  MBJ: [-77.913, 18.504], BGI: [-59.492, 13.075], SJU: [-66.002, 18.440],
  // Europe
  LHR: [-0.461, 51.477], CDG: [2.549, 49.010], FCO: [12.252, 41.800],
  BCN: [2.078, 41.297], MAD: [-3.567, 40.472], AMS: [4.764, 52.308],
  LIS: [-9.136, 38.774], OPO: [-8.681, 41.235], ATH: [23.944, 37.936],
  DUB: [-6.270, 53.421], CPH: [12.656, 55.618], ARN: [17.919, 59.652],
  OSL: [11.100, 60.194], HEL: [24.963, 60.317], VIE: [16.570, 48.110],
  PRG: [14.260, 50.101], BUD: [19.261, 47.437], WAW: [20.967, 52.165],
  BER: [13.405, 52.366], MUC: [11.786, 48.354], ZRH: [8.549, 47.458],
  MXP: [8.728, 45.630], NCE: [7.215, 43.658], EDI: [-3.373, 55.950],
  ORY: [2.359, 48.723], LGW: [-0.190, 51.148],
  // Middle East
  DXB: [55.364, 25.253], AUH: [54.651, 24.433], DOH: [51.608, 25.273],
  TLV: [34.887, 32.009], MCT: [58.284, 23.593], AMM: [35.992, 31.723],
  // Asia
  NRT: [140.386, 35.765], HND: [139.781, 35.549], KIX: [135.244, 34.427],
  ICN: [126.451, 37.463], HKG: [113.915, 22.309], TPE: [121.233, 25.077],
  PVG: [121.805, 31.143], PEK: [116.585, 40.080], BKK: [100.747, 13.681],
  HKT: [98.316, 8.113], CNX: [98.963, 18.768], DPS: [115.167, -8.748],
  SIN: [103.984, 1.350], KUL: [101.710, 2.746], HAN: [105.807, 21.221],
  SGN: [106.652, 10.819], MNL: [121.020, 14.509], CEB: [123.979, 10.308],
  REP: [103.813, 13.411], DEL: [77.103, 28.556], BOM: [72.868, 19.089],
  CMB: [79.885, 7.180], KTM: [85.360, 27.697], DMK: [100.607, 13.913],
  // Oceania
  SYD: [151.177, -33.946], MEL: [144.843, -37.673], BNE: [153.117, -27.384],
  AKL: [174.792, -37.008], NAN: [177.443, -17.755], PPT: [-149.607, -17.553],
  CHC: [172.532, -43.489], ZQN: [168.740, -45.021],
  // Africa
  CPT: [18.602, -33.965], JNB: [28.246, -26.134], NBO: [36.926, -1.319],
  RAK: [-8.036, 31.607], CMN: [-7.590, 33.367], DKR: [-17.490, 14.740],
  ADD: [38.799, 8.978], MRU: [57.683, -20.430], SEZ: [55.522, -4.674],
  LPA: [-15.386, 27.932],
};
